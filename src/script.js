...
window.addEventListener('click', () => {
    if(currentIntersect){
        switch(currentIntersect.object){
            case object1: 
                console.log('clicking object 1')
            break
            
            case object2:
                console.log('clicking object 2')
            break

            case object3:
                console.log('clicking object 3')
            break
        }
       
    }
    else if(currentIntersect === null){
        console.log('not clicking on sphere')
...
const tick = () =>
{
    ...
    //tell the raycaster the object is being clicked
